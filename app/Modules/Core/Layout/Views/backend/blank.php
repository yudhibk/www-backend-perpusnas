...
<head>
    ...
    <style>
        ...
        .bg-corporate-primary2{
            background-color: <?=get_parameter('corporate-primary2','#006060')?> !important;
        }
        .bg-corporate-secondary{
            background-color: <?=get_parameter('corporate-secondary','#008080')?>  !important;
        }
        .bg-corporate-secondary2{
            background-color: <?=get_parameter('corporate-secondary','#00A0A0')?>  !important;
        }
