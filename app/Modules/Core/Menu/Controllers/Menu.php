...
class Menu extends \App\Controllers\BaseController
{
    ...
    public function create()
    {
        ...
        $show_category = $this->request->getVar('show-category') ?? '1';
        ...
        if ($this->request->getPost() && $this->validation->withRequest($this->request)->run()) {
            ...
            if ($newMenuId) {
                ...
                return redirect()->to('/menu?slug=' . $slug . '&show-category=' . $show_category);
            } else {
                ...
                return redirect()->to('/menu/create?slug=' . $slug . '&show-category=' . $show_category);
            }
        } else {
