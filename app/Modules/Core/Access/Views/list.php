...
<div class="app-main__inner">
      ...
      <div class="page-title-actions">
        <nav class="" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="active breadcrumb-item" aria-current="page">Access</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <div class="container mb-4">
    <h3 class="text-center mb-4">Pilih Akun:</h3>
    <div class="tabs-animated-shadow tabs-animated nav nav-justified justify-content-center text-uppercase">
      <?php foreach ($groups as $row): ?>
        ...
        <a role="tab" class="border rounded bg-white nav-link <?= ($row->id == $group->id) ? 'active' : '' ?>" href="<?= base_url('access?group_id=' . $row->id) ?>" aria-selected="true">
          <span><?= $row->name ?></span>
        </a>
      <?php endforeach; ?>
    </div>
