...
<script>
	var defaultDropzoneUrl = "<?= base_url('event/do_upload') ?>";
	var defaultUrl = "<?= base_url('api/event/upload_file') ?>";
	var defaultFormat = "application/pdf";
	var defaultFile = 1;
	var defaultRedirect = "<?= base_url('event') ?>";
    ...
    $('.upload-data').click(function() {
		...
		setDropzone('file_pendukung', 'event', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
