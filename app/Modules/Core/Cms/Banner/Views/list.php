                        ...
                        <tr>
                            ...
                            <td width="90">
                                ...
                                <?php if(is_allowed('banner/delete')):?>
                                    <a href="javascript:void(0);" data-href="<?= base_url('banner/delete/' . $row->id); ?>" data-toggle="tooltip" data-placement="top" title="Hapus Banner" class="btn btn-danger remove-data"><i class="pe-7s-trash font-weight-bold"> </i></a>
                                <?php endif;?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
