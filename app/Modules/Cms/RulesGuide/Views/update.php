...
<div class="app-main__inner">
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">RulesGuide</a></li>
      ...
      <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Ubah Rules Guide
            </div>
            <div class="card-body">
                  <div id="infoMessage"><?= $message ?? ''; ?></div>
                  <?= get_message('message'); ?>

                  <form id="frm" class="col-md-12 mx-auto" method="post" action="<?= base_url('cms/rules-guide/edit/' . $rules_guide->id); ?>">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="title">Judul Rules Guide*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_title" name="title" placeholder="Judul Rules Guide" value="<?= $rules_guide->title; ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <select type="text" class="form-control" id="frm_create_category" name="category" placeholder="Kategori">
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_title" name="meta_title" placeholder="Meta Title" value="<?= $rules_guide->meta_title; ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_keywords" name="meta_keywords" placeholder="Kata Kunci" value="<?= $rules_guide->meta_keywords; ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_description" name="meta_description" placeholder="Meta Description" value="<?= $rules_guide->meta_description; ?>" />
                        ...
                        <div class="form-group">
                              ...
                              <div>
                                    <textarea id="frm_create_content" name="content" placeholder="Keterangan" rows="2" class="form-control autosize-input" style="min-height: 38px;"><?= $rules_guide->content ?></textarea>
                              </div>
                        </div>
...
<script>
      if ($('[type="file"]').length) {
            ...
            var dropzone_file = new Dropzone("#file", {
                  ...
                  url: "<?= base_url('cms/rules-guide/do_upload') ?>", // /do_uploads if multiple
                  ...
                  init: function() {
                        ...
                        var existingFile = "<?= isset($rules_guide->document) ?>";
                        if (existingFile) {
                              var files = existingFile.split(',');
                              files.forEach(function(file) {
                                    var uuid = Date.now();
                                    var modulePath = "<?= base_url('uploads/rules-guide/') ?>";
                  ...
                  removedfile: function(file) {
                        ...
                        if (file.upload !== undefined) {
                              ...
                              name = file.name;
                              path = "<?= ROOTPATH . 'public/uploads/rules-guide/' ?>";
                        }

                        $.ajax({
                              type: 'POST',
                              url: "<?= base_url('cms/rules-guide/do_delete') ?>",
