...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Pameran <?= ucwords(unslugify($slug)) ?>
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page">Tambah Pameran</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Pameran
            </div>
            <div class="card-body">
    ...
    : '' ?>><?= $row->name ?></option>
             ...
             'date_to'
						...
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<div>
									<input required type="text" class="form-control" id="contact" name="contact" placeholder="Contact Person" value="<?= set_value(
             'contact'
         ) ?>" />
								</div>
							</div>
           ...
           'description'
					...
					<div class="row">
						<div class="col-md-6">
							<div class="position-relative form-group">
								<label for="file_cover" class="">Upload Cover Pameran</label>
						...
						<div class="col-md-6">
							<div class="position-relative form-group">
								<label for="file_image" class="">Upload Galeri Pameran</label>
					...
					<?php if (is_admin()): ?>
						<?= $this->include('Pameran\Views\meta_add') ?>
					<?php endif; ?>
...
<?= $this->section('script') ?>
<?= $this->include('Pameran\Views\meta_add_script') ?>
<script>
	var file_cover = setDropzone('file_cover', 'cms/pameran', '.png,.jpg,.jpeg', 1, 2);
	var file_image = setDropzone('file_image', 'cms/pameran', '.png,.jpg,.jpeg,.mp3,.mp4,.mkv,.pdf', 4, 2);
</script>
<script>
