...
<script>
    var defaultDropzoneUrl = "<?= base_url('cms/publication/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/cms/publication/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('cms/publication') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'cms/publication', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
