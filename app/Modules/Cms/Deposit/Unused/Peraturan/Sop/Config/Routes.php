...
$routes->group('deposit/peraturan/sop', ['namespace' => 'DepositPeraturanSop\Controllers'], function ($subroutes) {
...
$routes->group('api/deposit/peraturan/sop', ['namespace' => 'DepositPeraturanSop\Controllers'], function ($subroutes) {
	/*** Route Update for Sop ***/
	$subroutes->add('', 'Sop::index');
	$subroutes->add('index', 'Sop::index');
	$subroutes->add('detail/(:any)', 'Sop::detail/$1');
