    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <form id="frm_create" class="col-md-12 mx-auto" method="post"
                action="<?= base_url('deposit/peraturan/sop/create'); ?>" enctype="multipart/form-data">
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <div>
                                ...
                                <small class="info help-block text-muted">Judul Peraturan SOP
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            ...
                                            <select type="text" class="form-control" id="frm_create_category"
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="position-relative form-group">
                                        <label for="file" class="">File <span
                                                class="font-italic text-secondary">(optional)</span></label>
                                        <div id="file" class="dropzone"></div>
                                        <div id="file_listed"></div>
                                        <div>
                                            <small class="info help-block text-muted">Format (PDF|XLS). Max 10
                                                MB</small>
                                        </div>
                                    </div>
                                </div>
