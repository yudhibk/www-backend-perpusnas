...
<script>
    var defaultDropzoneUrl = "<?= base_url('cms/rules-guide/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/cms/rules-guide/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('cms/rules-guide') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'cms/rules-guide', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
