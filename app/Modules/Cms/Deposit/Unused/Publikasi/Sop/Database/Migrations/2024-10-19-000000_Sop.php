...
namespace DepositPublikasiSop\Database\Migrations;
...
class Sop extends Migration
{
	public function up()
	{
		// t_deposit_publikasi_sop
		$this->forge->dropTable('t_deposit_publikasi_sop', true);
		$this->forge->addField([
		...
		$this->forge->createTable('t_deposit_publikasi_sop');
	}
