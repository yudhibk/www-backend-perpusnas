...
return [
   ...
   'info.successfully_saved' => 'Sop berhasil disimpan',
   'info.successfully_deleted' => 'Sop berhasil dihapus',
   'info.successfully_updated' => 'Sop berhasil diubah',
   'info.error' => 'Error',
   'info.failed' => 'Gagal',
   'info.failed_to_save' => 'Sop gagal disimpan',
   'info.failed_to_delete' => 'Sop gagal dihapus',
   'info.failed_to_update' => 'Sop gagal diubah',
