...
<script>
    var defaultDropzoneUrl = "<?= base_url('sop/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/sop/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('sop') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'sop', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
