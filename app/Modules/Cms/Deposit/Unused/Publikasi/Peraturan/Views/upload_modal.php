...
<script>
    var defaultDropzoneUrl = "<?= base_url('peraturan/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/peraturan/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('peraturan') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'peraturan', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
