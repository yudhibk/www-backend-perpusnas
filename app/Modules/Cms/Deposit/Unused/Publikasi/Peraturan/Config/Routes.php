...
$routes->group('deposit/publikasi/peraturan', ['namespace' => 'DepositPublikasiPeraturan\Controllers'], function ($subroutes) {
...
$routes->group('api/deposit/publikasi/peraturan', ['namespace' => 'DepositPublikasiPeraturan\Controllers\Api'], function ($subroutes) {
	/*** Route Update for Peraturan ***/
	$subroutes->add('', 'Peraturan::index');
	$subroutes->add('index', 'Peraturan::index');
	$subroutes->add('detail/(:any)', 'Peraturan::detail/$1');
