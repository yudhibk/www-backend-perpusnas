...
<div class="app-main__inner">
      <div class="app-page-title">
            <div class="page-title-wrapper">
                  <div class="page-title-heading">
                        ...
                        <div>Tambah Pengajuan Bahan Pustaka Deposit
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Pengajuan Bahan Pustaka</a></li>
      ...
      <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                  ...
                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url('deposit/pengajuan/bahan-pustaka/create'); ?>">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="name">Judul Pengajuan Bahan Pustaka*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="title" placeholder="Judul Pengajuan Bahan Pustaka" value="<?= set_value('title'); ?>" />
                                                <small class="info help-block text-muted">Judul Pengajuan Bahan Pustaka</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_title"
...
<?= $this->section('script'); ?>
<script>
      var file_image = setDropzone('file', 'deposit/pengajuan/bahan-pustaka', '.pdf', 1, 10);
