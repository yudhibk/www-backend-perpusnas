...
<div class="app-main__inner">
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Bahanpustaka</a></li>
      ...
      <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Ubah Bahanpustaka
            </div>
            <div class="card-body">
                  <div id="infoMessage"><?= $message ?? ''; ?></div>
                  <?= get_message('message'); ?>

                  <form id="frm" class="col-md-12 mx-auto" method="post" action="<?= base_url('deposit/pengajuan/bahan-pustaka/edit/' . $bahanpustaka->id); ?>" enctype="multipart/form-data">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="name">Judul Bahanpustaka*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="title" placeholder="Judul Bahanpustaka" value="<?= $bahanpustaka->title ?>" />
                                                <small class="info help-block text-muted">Judul Bahanpustaka</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
                                    ...
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_title" name="meta_title"
                                                      placeholder="Meta Title" value="<?= $bahanpustaka->meta_title; ?>" />
                                    ...
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_keywords"
                                                      name="meta_keywords" placeholder="Kata Kunci" value="<?= $bahanpustaka->meta_keywords; ?>" />
                                    ...
                                    <div class="position-relative form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_meta_description"
                                                      ...
                                                      value="<?= $bahanpustaka->meta_description; ?>" />
                        ...
                        <div class="form-group">
                              ...
                              <div>
                                    <textarea id="content" name="content" placeholder="Keterangan" rows="2"
                                          class="form-control autosize-input"
                                          style="min-height: 38px;"><?= $bahanpustaka->content ?></textarea>
                              </div>
                        </div>
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    ...
                                    <?php if (!empty($bahanpustaka->file) && file_exists(FCPATH . 'uploads/deposit/pengajuan/bahan-pustaka/' . $bahanpustaka->file)): ?>
                                          <div id="existing_file" class="mt-3">
                                                <p><strong>Existing File:</strong></p>
                                                <?php
                                                $filePath = base_url('uploads/deposit/pengajuan/bahan-pustaka/' . $bahanpustaka->file);
                                                $fileType = mime_content_type(FCPATH . 'uploads/deposit/pengajuan/bahan-pustaka/' . $bahanpustaka->file);
                                                ?>
...
<script>
      ...
      var dropzone_file = new Dropzone("#file", {
            ...
            url: "<?= base_url('deposit/pengajuan/bahan-pustaka/do_upload') ?>", // /do_uploads if multiple
            ...
            init: function() {
                  ...
                  var existingFile = "<?= $bahanpustaka->file ?>";
                  if (existingFile) {
                        var files = existingFile.split(',');
                        files.forEach(function(file) {
                              var uuid = Date.now();
                              var modulePath = "<?= base_url('uploads/deposit/pengajuan/bahan-pustaka/') ?>";
            ...
            removedfile: function(file) {
                  ...
                  if (file.upload !== undefined) {
                        ...
                        name = file.name;
                        path = "<?= ROOTPATH . 'public/uploads/deposit/pengajuan/bahan-pustaka/' ?>";
                  }

                  $.ajax({
                        type: 'POST',
                        url: "<?= base_url('deposit/pengajuan/bahan-pustaka/do_delete') ?>",
