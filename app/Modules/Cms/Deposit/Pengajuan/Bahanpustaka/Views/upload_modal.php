...
<script>
    var defaultDropzoneUrl = "<?= base_url('deposit/pengajuan/bahan-pustaka/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/deposit/pengajuan/bahan-pustaka/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('deposit/pengajuan/bahan-pustaka') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'deposit/pengajuan/bahan-pustaka', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
