...
namespace DepositPengajuanNaskahkuno\Database\Migrations;

use CodeIgniter\Database\Migration;

class Naskahkuno extends Migration
{
	public function up()
	{
		// t_deposit_pengajuan_naskah_kuno
		$this->forge->dropTable('t_deposit_pengajuan_naskah_kuno', true);
		$this->forge->addField([
		...
		$this->forge->createTable('t_deposit_pengajuan_naskah_kuno');
	}
