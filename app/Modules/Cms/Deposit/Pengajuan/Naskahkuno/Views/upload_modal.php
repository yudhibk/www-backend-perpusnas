...
<script>
    var defaultDropzoneUrl = "<?= base_url('deposit/pengajuan/naskah-kuno/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/deposit/pengajuan/naskah-kuno/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('deposit/pengajuan/naskah-kuno') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'deposit/pengajuan/naskah-kuno', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
