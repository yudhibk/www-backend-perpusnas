...
<div class="app-main__inner">
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Naskahkuno</a></li>
      ...
      <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Ubah Naskahkuno
            </div>
            <div class="card-body">
                  <div id="infoMessage"><?= $message ?? ''; ?></div>
                  <?= get_message('message'); ?>

                  <form id="frm" class="col-md-12 mx-auto" method="post" action="<?= base_url('deposit/pengajuan/naskah-kuno/edit/' . $naskahkuno->id); ?>" enctype="multipart/form-data">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="name">Judul Naskahkuno*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="title" placeholder="Judul Naskahkuno" value="<?= $naskahkuno->title ?>" />
                                                <small class="info help-block text-muted">Judul Naskahkuno</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="frm_create_meta_title" name="meta_title"
                                    placeholder="Meta Title" value="<?= $naskahkuno->meta_title; ?>" />
                        ...
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="frm_create_meta_keywords"
                                    name="meta_keywords" placeholder="Kata Kunci" value="<?= $naskahkuno->meta_keywords; ?>" />
                        ...
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="frm_create_meta_description"
                                    ...
                                    value="<?= $naskahkuno->meta_description; ?>" />
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="frm_create_content" name="content" placeholder="Keterangan" rows="2"
                            ...
                            style="min-height: 38px;"><?= $naskahkuno->content ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        ...
                        <?php if (!empty($naskahkuno->file) && file_exists(FCPATH . 'uploads/deposit/pengajuan/naskah-kuno/' . $naskahkuno->file)): ?>
                        <div id="existing_file" class="mt-3">
                            <p><strong>Existing File:</strong></p>
                            <?php
            $filePath = base_url('uploads/deposit/pengajuan/naskah-kuno/' . $naskahkuno->file);
            $fileType = mime_content_type(FCPATH . 'uploads/deposit/pengajuan/naskah-kuno/' . $naskahkuno->file);
            ?>
...
<script>
      ...
      var dropzone_file = new Dropzone("#file", {
            ...
            url: "<?= base_url('deposit/pengajuan/naskah-kuno/do_upload') ?>", // /do_uploads if multiple
            ...
            init: function() {
                  ...
                  var existingFile = "<?= $naskahkuno->file ?>";
                  if (existingFile) {
                        var files = existingFile.split(',');
                        files.forEach(function(file) {
                              var uuid = Date.now();
                              var modulePath = "<?= base_url('uploads/deposit/pengajuan/naskah-kuno/') ?>";
            ...
            removedfile: function(file) {
                  ...
                  if (file.upload !== undefined) {
                        ...
                        name = file.name;
                        path = "<?= ROOTPATH . 'public/uploads/deposit/pengajuan/naskah-kuno/' ?>";
                  }

                  $.ajax({
                        type: 'POST',
                        url: "<?= base_url('deposit/pengajuan/naskah-kuno/do_delete') ?>",
