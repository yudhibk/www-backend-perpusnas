...
<script>
    var defaultDropzoneUrl = "<?= base_url('deposit/laporan/pengadaan/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/deposit/laporan/pengadaan/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('deposit/laporan/pengadaan') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'deposit/laporan/pengadaan', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
