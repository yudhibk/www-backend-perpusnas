...
<div class="app-main__inner">
      <div class="app-page-title">
            <div class="page-title-wrapper">
                  <div class="page-title-heading">
                        ...
                        <div>Tambah Laporan Pengadaan Deposit
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Laporan Pengadaan</a></li>
      ...
      <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                  ...
                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url('deposit/laporan/pengadaan/create'); ?>" enctype="multipart/form-data">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="name">Judul Laporan Pengadaan*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="name" placeholder="Judul Laporan Pengadaan" value="<?= set_value('name'); ?>" />
                                                <small class="info help-block text-muted">Judul Laporan Pengadaan</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
...
<?= $this->section('script'); ?>
<script>
      var file_image = setDropzone('file', 'deposit/laporan/pengadaan', '.pdf', 1, 10);
