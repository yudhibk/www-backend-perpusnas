...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Koleksi <?=ucwords(unslugify($slug))?>
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('cms/koleksi')?>">Koleksi</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Tambah Koleksi</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Koleksi
            </div>
            <div class="card-body">
				<div id="infoMessage"><?=$message ?? '';?></div>
				<?=get_message('message');?>

				<form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?=base_url('cms/koleksi/create?slug=' . $slug);?>">
					<div class="form-row">
						<div class="col-md-12">
							<div class="position-relative form-group">
								<label for="name">Judul Koleksi*</label>
								<div>
									<input required type="text" class="form-control" id="title" name="title" placeholder="Judul Koleksi" value="<?= set_value('title'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-3">
							...
							<div class="position-relative form-group">
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="file_source" id="source1" value="upload" checked>
										<label class="form-check-label" for="source1">Upload File</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="file_source" id="source2" value="url">
					...
					<div class="form-row file_source_upload">
						<div class="col-md-12">
							<div class="position-relative form-group">
								...
								<div>
									<small class="info help-block text-muted">Format (JPG|PNG). Max 4 Files @10MB</small>
								</div>
							</div>
						</div>
					</div>

					<div class="row file_source_url" style="display:none">
						<?php
							$file_urls = explode(',',',,,');							
						?>
						<div class="col-md-12">
...
<script>
	...
	var file_image = setDropzone('file_image', 'cms/koleksi', '.png,.jpg,.jpeg,.mp3,.mp4,.mkv,.pdf', 4, 10);
</script>
<script>
