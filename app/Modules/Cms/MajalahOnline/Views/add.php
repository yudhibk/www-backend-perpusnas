...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('cms/majalahonline')?>">Majalah Online</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Tambah Majalah Online</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
		<div class="card-header">
				<i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Majalah Online
		</div>
		<div class="card-body">
			<div id="infoMessage"><?=$message ?? '';?></div>
			<?=get_message('message');?>

			<form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?=base_url('cms/majalahonline/create?slug=' . $slug);?>">
				<div class="form-row">
					<div class="col-md-12">
						<div class="position-relative form-group">
							<label for="name">Judul Majalah Online*</label>
							<div>
								<input required type="text" class="form-control" id="title" name="title" placeholder="Judul Majalah Online" value="<?=set_value('title');?>" />
							</div>
						</div>
					</div>
					<div class="col-md-3">
				...
				<div class="form-row">
					<div class="col-md-3">
						<div class="position-relative form-group">
							...
							<div>
								<input type="text" class="form-control" id="edition" name="edition" placeholder="Edition" value="<?=set_value('edition');?>" />
							</div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="position-relative form-group">
							...
							<div>
								<input type="text" class="form-control" id="subject" name="subject" placeholder="Subject" value="<?=set_value('subject');?>" />
							</div>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-12">
						<div class="position-relative form-group">
							...
							<div>
								<input type="text" class="form-control" id="keyword" name="keyword" placeholder="Keyword" value="<?=set_value('keyword');?>" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="position-relative form-group">
							...
							<div>
								<small class="info help-block text-muted">Format (PDF). Max 4 Files @ 10MB</small>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	var file_image = setDropzone('file_image', 'cms/koleksiumum', '.pdf', 4, 10);
</script>
<script>
