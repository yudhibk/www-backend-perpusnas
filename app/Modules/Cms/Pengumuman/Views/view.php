...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('pengumuman') ?>"> Artikel Pengumuman</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Detail Artikel Pengumuman</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Detail Artikel Pengumuman
            </div>
            <div class="card-body">
                  ...
                  <form id="frm_create"  method="post" action="">
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="title" name="title" placeholder="Judul Artikel" value="<?= set_value('title', $pengumuman->title); ?>" />
                                          </div>
                                    </div>
                              </div>
                              <div class="col-md-3">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="author" name="author" placeholder="Pengarang/Penulis" value="<?= set_value('author', $pengumuman->author); ?>" />
                                          </div>
                                    </div>
                              </div>
                              <div class="col-md-3">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="edition" name="edition" placeholder="Edisi" value="<?= set_value('edition', $pengumuman->edition); ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <textarea id="description" name="description" placeholder="Abstrak" rows="1" class="form-control autosize-input"><?= set_value('description', $pengumuman->description); ?></textarea>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="subject" name="subject[]" multiple="multiple">
                                                      <?php $tags = explode(";", $pengumuman->subject);?>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="author_additional" name="author_additional[]" multiple="multiple">
                                                      <?php $tags = explode(";", $pengumuman->author_additional);?>
                                                      <?php foreach ($tags as $row): ?>
                                                      <option value="<?=$row?>" selected><?=$row?></option>
                                                      <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="institution" name="institution[]" multiple="multiple">
                                                      <?php $tags = explode(";", $pengumuman->institution);?>
                                                      <?php foreach ($tags as $row): ?>
                                                      <option value="<?=$row?>" selected><?=$row?></option>
                                                      <?php endforeach; ?>
                                                </select>
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="url" name="url" placeholder="https://file.perpusnas.go.id/digital/123" value="<?= set_value('url', $pengumuman->url); ?>" />
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="source" name="source" placeholder="Sumber Artikel" value="<?= set_value('source', $pengumuman->source); ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            <a href="<?= base_url('uploads/pengumuman/' . $pengumuman->file_image) ?>" class="image-link"><img width="150" class="rounded" src="<?= base_url('uploads/pengumuman/' . $pengumuman->file_image) ?>" alt=""></a>
                                        </div>
                                    </div>
                              </div>
                              <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            <a href="<?= base_url('flip?path=pengumuman&file=' . $pengumuman->file_pdf) ?>" class="ajax-popup-link">
                        ...
                        <div class="form-group">
                            <a href="<?=base_url('pengumuman')?>" class="btn btn-primary">Kembali</a>
                        </div>
                  </form>
            </div>
    </div>
