...
<div class="app-main__inner">
                ...
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('auth') ?>"><i class="fa fa-home"></i>
                                Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('direktori') ?>"> Direktori</a></li>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header">
            <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Direktori
        </div>
        <div class="card-body">
            ...
            <form id="frm" class="col-md-12 mx-auto" method="post" action="">
                        ...
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Nama Direktori" value="<?= set_value('title'); ?>" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="website" name="website"
                                    placeholder="Website" value="<?= set_value('website'); ?>" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="position-relative form-group">
                        ...
                        <div>
                            <input type="text" class="form-control" id="address" name="address" placeholder="Alalmat"
...
var file_pdf = setDropzone('file_pdf', 'page', '.pdf', 1, 10);
</script>
