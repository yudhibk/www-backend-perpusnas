            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('kamus') ?>"> Artikel Berita</a></li>
    ...
    <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                  ...
                  <form id="frm_create"  method="post" action="">
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="title" name="title" placeholder="Judul Artikel" value="<?= set_value('title', $kamus->title); ?>" />
                                          </div>
                                    </div>
                              </div>
                              <div class="col-md-3">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="author" name="author" placeholder="Pengarang/Penulis" value="<?= set_value('author', $kamus->author); ?>" />
                                          </div>
                                    </div>
                              </div>
                              <div class="col-md-3">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="edition" name="edition" placeholder="Edisi" value="<?= set_value('edition', $kamus->edition); ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <textarea id="description" name="description" placeholder="Abstrak" rows="1" class="form-control autosize-input"><?= set_value('description', $kamus->description); ?></textarea>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="subject" name="subject[]" multiple="multiple">
                                                      <?php $tags = explode(";", $kamus->subject);?>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="author_additional" name="author_additional[]" multiple="multiple">
                                                      <?php $tags = explode(";", $kamus->author_additional);?>
                                                      <?php foreach ($tags as $row): ?>
                                                      <option value="<?=$row?>" selected><?=$row?></option>
                                                      <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="institution" name="institution[]" multiple="multiple">
                                                      <?php $tags = explode(";", $kamus->institution);?>
                                                      <?php foreach ($tags as $row): ?>
                                                      <option value="<?=$row?>" selected><?=$row?></option>
                                                      <?php endforeach; ?>
                                                </select>
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="url" name="url" placeholder="https://file.perpusnas.go.id/digital/123" value="<?= set_value('url', $kamus->url); ?>" />
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="source" name="source" placeholder="Sumber Artikel" value="<?= set_value('source', $kamus->source); ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            <a href="<?= base_url('uploads/kamus/' . $kamus->file_image) ?>" class="image-link"><img width="150" class="rounded" src="<?= base_url('uploads/kamus/' . $kamus->file_image) ?>" alt=""></a>
                                        </div>
                                    </div>
                              </div>
                              <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            <a href="<?= base_url('flip?path=kamus&file=' . $kamus->file_pdf) ?>" class="ajax-popup-link">
                        ...
                        <div class="form-group">
                            <a href="<?=base_url('kamus')?>" class="btn btn-primary">Kembali</a>
                        </div>
                  </form>
            </div>
    </div>
