...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                  ...
                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?=base_url('cms/kamus/create?slug=' . $slug);?>">
						<div class="form-row">
							<div class="col-md-12">
								<div class="position-relative form-group">
									<label for="name">Judul Kamus*</label>
									<div>
										<input type="text" class="form-control" id="title" name="title" placeholder="Judul Kamus" value="<?=set_value('title');?>" />
									</div>
								</div>
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="position-relative form-group">
									...
									<div>
										<input type="date" class="form-control" id="publish_date" name="publish_date" placeholder="Tanggal Post" value="<?=set_value('publish_date');?>" />
									</div>
								</div>
							</div>
						</div>
