    ...
    <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate">
            ...
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if(is_allowed('layanan/create')):?>
                <a href="<?= base_url('cms/layanan/create?slug='.$slug) ?>" class=" btn btn-success" title=""><i class="fa fa-plus"></i>
                    Tambah Layanan </a>
                <?php endif;?>
            </div>
        </div>
...
<script>
	...
	$(document).ready(function() {
		t = $('#tbl_grid').DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": '<?php echo site_url('api/layanan/datatable/'.$slug) ?>',
			},
			"dom": 
