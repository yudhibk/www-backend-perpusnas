...
<div class="app-main__inner">
      ...
      <div class="page-title-actions">
        <nav class="" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('cms/layanan') ?>">Layanan</a></li>
            <li class="active breadcrumb-item" aria-current="page">Tambah Layanan</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <div class="main-card mb-3 card">
    <div class="card-header">
      <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Layanan
    </div>
    <div class="card-body">
        ...
        <div class="form-row">
          ...
          <div class="col-md-7">
            <div class="position-relative form-group">
              ...
              <div>
                <input type="text" class="form-control" name="title" id="title" placeholder="Judul Layanan " value="<?= set_value('title'); ?>" />
              </div>
            </div>
          </div>
          <div class="col-md-2">
