...
class Layanan extends \App\Controllers\BaseController
{
  ...
  {
    if (!(is_allowed('layanan/access') || is_allowed('cms/layanan/access'))) {
  ...
  {
    if (!(is_allowed('layanan/read') || is_allowed('cms/layanan/read'))) {
      set_message('toastr_msg', lang('App.permission.not.have'));
      set_message('toastr_type', 'error');
      return redirect()->to('/dashboard');
    }
  ...
  {
    if (!(is_allowed('layanan/create') || is_allowed('cms/layanan/create'))) {
      set_message('toastr_msg', lang('App.permission.not.have'));
      set_message('toastr_type', 'error');
      return redirect()->to('/dashboard');
    }
  ...
  {
    if (!(is_allowed('layanan/update') || is_allowed('cms/layanan/update'))) {
      set_message('toastr_msg', lang('App.permission.not.have'));
      set_message('toastr_type', 'error');
      return redirect()->to('/cms/layanan');
    }
    ...
    if (!$id) {
      set_message('toastr_msg', 'Layanan tidak ditemukan');
      set_message('toastr_type', 'error');
      return redirect()->to('/cms/layanan');
    }
  ...
  {
    if (!(is_allowed('layanan/delete') || is_allowed('cms/layanan/delete'))) {
      set_message('toastr_msg', lang('App.permission.not.have'));
      set_message('toastr_type', 'error');
      return redirect()->to('/dashboard');
    }
  ...
  {
    if (!(  is_allowed('layanan/export') || is_allowed('cms/layanan/export') )) {
      set_message('toastr_msg', lang('App.permission.not.have'));
      set_message('toastr_type', 'error');
      return redirect()->to('/dashboard');
    }
