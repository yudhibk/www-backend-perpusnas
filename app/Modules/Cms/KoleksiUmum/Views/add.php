...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('cms/koleksiumum')?>">Koleksi Umum</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Tambah Koleksi Umum</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
		<div class="card-header">
				<i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Koleksi Umum
		</div>
		<div class="card-body">
			<div id="infoMessage"><?=$message ?? '';?></div>
			<?=get_message('message');?>

			<form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?=base_url('cms/koleksiumum/create?slug=' . $slug);?>">
				<div class="form-row">
					<div class="col-md-12">
						<div class="position-relative form-group">
							<label for="name">Judul Koleksi Umum*</label>
							<div>
								<input required type="text" class="form-control" id="title" name="title" placeholder="Judul Koleksi Umum" value="<?=set_value('title');?>" />
							</div>
						</div>
					</div>
					<div class="col-md-3">
				...
				<div class="form-row">
					<div class="col-md-3">
						<div class="position-relative form-group">
							<label for="numbers">No. Koleksi</label>
							<div>
								<input type="text" class="form-control" id="numbers" name="numbers" placeholder="No. Koleksi" value="<?=set_value('numbers');?>" />
							</div>
						</div>
					</div>
					<div class="col-md-3">
...
<script>
	...
	var file_image = setDropzone('file_image', 'cms/koleksiumum', '.png,.jpg,.jpeg', 4, 2);
</script>
<script>
