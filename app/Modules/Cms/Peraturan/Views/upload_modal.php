...
<script>
    var defaultDropzoneUrl = "<?= base_url('cms/uusskckr/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/uusskckr/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('cms/uusskckr') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'cms/uusskckr', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
