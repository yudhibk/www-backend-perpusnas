...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Agenda <?=ucwords(unslugify($slug))?>
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('cms/agenda')?>">Agenda</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Tambah Agenda</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Agenda
            </div>
            <div class="card-body">
				<div id="infoMessage"><?=$message ?? '';?></div>
				<?=get_message('message');?>

				<form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?=base_url('cms/agenda/create?slug=' . $slug);?>">
					<div class="form-row">
						<div class="col-md-12">
							<div class="position-relative form-group">
								<label for="name">Judul Agenda*</label>
								<div>
									<input required type="text" class="form-control" id="title" name="title" placeholder="Judul Agenda" value="<?= set_value('title'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-3">
					...
					<div class="form-row">
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<div>
									<input required type="date" class="form-control" id="date_from" name="date_from" placeholder="Tanggal Mulai" value="<?= set_value('date_from'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<div>
									<input required type="date" class="form-control" id="date_to" name="date_to" placeholder="Tanggal Selesai" value="<?= set_value('date_to'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<div>
									<input required type="text" class="form-control" id="contact" name="contact" placeholder="Contact Person" value="<?= set_value('contact'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<div>
									<input type="text" class="form-control" id="organizer" name="organizer" placeholder="Penyelenggara" value="<?= set_value('organizer'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="position-relative form-group">
								...
								<div>
									<input type="text" class="form-control" id="place" name="place" placeholder="Tempat" value="<?= set_value('place'); ?>" />
					...
					<?php if (is_admin()): ?>
						<?=$this->include('Agenda\Views\meta_add');?>
					<?php endif;?>
...
<?=$this->section('script');?>
<?=$this->include('Agenda\Views\meta_add_script');?>
<script>
