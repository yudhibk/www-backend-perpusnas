...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page">Tambah Kuesioner</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Kuesioner
            </div>
            <div class="card-body">
                        ...
                        <div class="form-row">
							  <div class="col-md-8">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Pertanyaan" value="<?= set_value(
                                                    'name'
                                                ) ?>" />
                                          </div>
                                    </div>
							  ...
							  <div class="col-md-3">
                                    <div class="position-relative form-group">
                                          ...
                                          <select class="form-control" name="category" id="indicator_id" tabindex="-1" aria-hidden="true">
										  		<?php foreach (get_ref('ref-indikator', 'slug') as $row): ?>
                              ...
                              <div class="col-md-1">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="sort" name="sort" placeholder="Urutan" value="<?= set_value(
                                                    'sort'
                                                ) ?>" />
                                          </div>
                                    </div>
                ...
                'description'
                        ...
                        <div class="form-group">
                              <button type="submit" class="btn btn-primary" name="submit"><?= lang(
                                  'App.btn.save'
                              ) ?></button>
                        </div>
                  </form>
...
<script>
	$(document).ready(function() {
		...
		addIndicator('Sangat Puas', 5);
		addIndicator('Puas', 4);
		addIndicator('Cukup Puas', 3);
		addIndicator('Kurang Puas', 2);
		addIndicator('Tidak Puas', 1);
