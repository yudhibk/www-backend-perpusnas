...
<script>
    var defaultDropzoneUrl = "<?= base_url('cms/histori-direktur/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/cms/histori-direktur/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('cms/histori-direktur') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'cms/histori-direktur', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
