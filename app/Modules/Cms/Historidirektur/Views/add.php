...
<div class="app-main__inner">
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Histori Direktur</a></li>
      ...
      <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                  ...
                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url('cms/histori-direktur/create'); ?>">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="name">Nama Direktur/Kepala Pusat*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="name" placeholder="Judul Histori Direktur" value="<?= set_value('name'); ?>" />
                                                <small class="info help-block text-muted">Nama Direktur/Kepala Pusat</small>
                                          </div>
                                    </div>
                              </div>
                        ...
                        <dic class="form-row">
                              <div class="col-md-6">
                                    <input type="date" class="form-control" id="frm_create_date" name="awal_menjabat" placeholder="Awal Menjabat" value="<?= set_value('awal_menjabat'); ?>" />
                              </div>
                              <div class="col-md-6">
                                    <input type="date" class="form-control" id="frm_create_date" name="akhir_menjabat" placeholder="Akhir Menjabat" value="<?= set_value('akhir_menjabat'); ?>" />
                              </div>
                        </dic>
                        ...
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="file" class="">Masukan Foto <span class="font-italic text-secondary">(optional)</span></label>
                                          <div id="file" class="dropzone"></div>
                                          <div id="file_listed"></div>
                                          <div>
                                                <small class="info help-block text-muted">Format Image. Max 10 MB</small>
                                          </div>
                                    </div>
                              </div>
                        </div>
...
<?= $this->section('script'); ?>
<script>
      var file_image = setDropzone('file', 'cms/histori-direktur', '.pdf,.jpg,.jpeg,.png', 1, 10);
