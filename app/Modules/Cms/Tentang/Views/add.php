...
<div class="app-main__inner">
      ...
      <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                  ...
                  <form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url('cms/tentang/create'); ?>">
                        <div class="form-row">
                              <div class="col-md-12">
                                    <div class="position-relative form-group">
                                          <label for="name">Judul Tentang*</label>
                                          <div>
                                                <input type="text" class="form-control" id="frm_create_name" name="name" placeholder="Judul Tentang" value="<?= set_value('name'); ?>" />
...
<?= $this->section('script'); ?>
<script>
      var file_image = setDropzone('file', 'tentang', '.pdf,.xls,.xlsx', 1, 10);
