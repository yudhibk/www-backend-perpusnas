...
<script>
    var defaultDropzoneUrl = "<?= base_url('cms/tentang/do_upload') ?>";
    var defaultUrl = "<?= base_url('api/tentang/upload_file') ?>";
    var defaultFormat = "application/pdf";
    var defaultFile = 1;
    var defaultRedirect = "<?= base_url('tentang') ?>";
    ...
    $('.upload-data').click(function() {
        ...
        setDropzone('file_pendukung', 'tentang', $('#upload_data_format').val(), $('#upload_data_file').val(), 10);
    });
