...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('berita') ?>"> Berita Berita</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Detail Berita Berita</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Detail Berita Berita
            </div>
            <div class="card-body">
                        ...
                        <div class="form-row">
                              ...
                              <div class="col-md-3">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="author" name="author" placeholder="Pengarang/Penulis" value="<?= set_value('author', $berita->author); ?>" />
                                          </div>
                                    </div>
                              </div>
                              <div class="col-md-3">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="edition" name="edition" placeholder="Edisi" value="<?= set_value('edition', $berita->edition); ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <textarea id="description" name="description" placeholder="Abstrak" rows="1" class="form-control autosize-input"><?= set_value('description', $berita->description); ?></textarea>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="subject" name="subject[]" multiple="multiple">
                                                      <?php $tags = explode(";", $berita->subject);?>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="author_additional" name="author_additional[]" multiple="multiple">
                                                      <?php $tags = explode(";", $berita->author_additional);?>
                                                      <?php foreach ($tags as $row): ?>
                                                      <option value="<?=$row?>" selected><?=$row?></option>
                                                      <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <select class="form-control tags" id="institution" name="institution[]" multiple="multiple">
                                                      <?php $tags = explode(";", $berita->institution);?>
                                                      <?php foreach ($tags as $row): ?>
                                                      <option value="<?=$row?>" selected><?=$row?></option>
                                                      <?php endforeach; ?>
                                                </select>
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="url" name="url" placeholder="https://file.perpusnas.go.id/digital/123" value="<?= set_value('url', $berita->url); ?>" />
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                          <label for="source">Sumber Berita</label>
                                          <div>
                                                <input type="text" class="form-control" id="source" name="source" placeholder="Sumber Berita" value="<?= set_value('source', $berita->source); ?>" />
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            <a href="<?= base_url('uploads/berita/' . $berita->file_image) ?>" class="image-link"><img width="150" class="rounded" src="<?= base_url('uploads/berita/' . $berita->file_image) ?>" alt=""></a>
                                        </div>
                                    </div>
                              </div>
                              <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <div>
                                            <a href="<?= base_url('flip?path=berita&file=' . $berita->file_pdf) ?>" class="ajax-popup-link">
