...
<div class="app-main__inner">
            ...
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('cms/berita')?>">Berita</a></li>
    ...
    <div class="main-card mb-3 card">
            ...
            <div class="card-body">
				...
				<form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?=base_url('cms/berita/create?slug=' . $slug);?>">
					<div class="form-row">
						<div class="col-md-12">
							<div class="position-relative form-group">
								<label for="name">Judul Berita*</label>
								<div>
									<input required type="text" class="form-control" id="title" name="title" placeholder="Judul Berita" value="<?= set_value('title'); ?>" />
								</div>
							</div>
						</div>
						<div class="col-md-3">
					...
					<div class="form-group">
							<label for="content">Uraian Translate Bahasa Inggris</label>
							<div>
								<textarea id="content1" name="en_content" placeholder="" rows="1" class="form-control autosize-input"><?= set_value('en_content'); ?></textarea>
							</div>
					</div>
...
<script>
	...
	var file_image = setDropzone('file_image', 'cms/berita', '.png,.jpg,.jpeg,.mp3,.mp4,.mkv,.pdf', 4, 2);
</script>
<script>
